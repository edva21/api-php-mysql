DROP DATABASE prodookingdb;
DROP USER prodUsr;
CREATE DATABASE prodookingdb;
CREATE USER prodUsr IDENTIFIED BY 'prodRoot';
GRANT ALL PRIVILEGES ON prodookingdb.* to prodUsr@localhost IDENTIFIED BY 'prodRoot';
USE prodookingdb;
